## 문제
p.215 https://algospot.com/judge/problem/read/JUMPGAME

![](https://algospot.com/media/judge-attachments/3a3560eb4194bc927e325514b88468df/jumpgame.png)
...
```
- 포인터 변수를 활용한다: 캐시한 값을 가져오고 저장하는 방법 사용
- 초기값을 -1로 함으로써 0, 1과 구분할 수 있게 됨